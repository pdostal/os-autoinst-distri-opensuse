...
our @EXPORT = qw(test_seccomp basic_container_tests get_vars can_build_sle_base check_containers_firewall
...
sub check_containers_firewall {
    ...
    $runtime->check_containers_firewall() || die 'Subroutine check_containers_firewall() supports only docker and podman runtimes';;
}
